...
public class App extends JFrame implements MouseListener {
    ...
    App() {
        ...
        bandiera = new ImageIcon(new ImageIcon("flag.png").getImage().getScaledInstance(100, 100, Image.SCALE_SMOOTH));
        ...
        for (int i = 0; i < w; i++) {
            for (int j = 0; j < h; j++) {
                ...
                etic[i][j] = new JLabel();
                etic[i][j].setBorder(BorderFactory.createLineBorder(Color.black, 2));
